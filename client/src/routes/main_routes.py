...
def devices():
    onus_ubiquiti = requests.get("http://127.0.0.1:8000/api/v1.0/ressources/ubiquiti/onus").json()
    olt_ubiquiti = requests.get("http://127.0.0.1:8000/api/v1.0/ressources/ubiquiti/olt").json()
